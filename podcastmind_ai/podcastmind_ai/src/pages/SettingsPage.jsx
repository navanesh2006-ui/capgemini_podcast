...
export default function SettingsPage() {
  ...
  return (
    <motion.div
      ...
      exit={{ opacity: 0, y: -15 }}
      className="p-6 md:p-8 space-y-8 max-w-4xl mx-auto ml-64 min-h-screen pb-16"
    >
      {/* Header */}
        ...
        <div className="flex flex-col md:flex-row gap-6 items-center">
          <div className="relative group">
            <img
              ...
              alt="Avatar"
              className="w-20 h-20 rounded-2xl object-cover ring-2 ring-primary/45"
            />
            <div className="absolute inset-0 bg-black/40 rounded-2xl flex items-center justify-center opacity-0 group-hover:opacity-100 cursor-pointer transition-all">
      ...
      <div className="p-6 rounded-2xl border border-red-500/10 bg-red-500/[0.01] space-y-4">
        ...
        <div className="flex items-center justify-between py-1">
          ...
          <button className="px-4 py-2.5 rounded-xl bg-red-500/10 hover:bg-red-500/20 text-red-400 border border-red-500/20 text-xs font-bold transition-all cursor-pointer">
            Delete Account
          </button>
        </div>
      </div>
