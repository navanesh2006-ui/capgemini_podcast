                ...
                <Tooltip 
                  content={({ active, payload }) => {
                    if (active && payload && payload.length) {
                      return (
                        <div className="bg-[#13131A]/95 border border-white/10 p-3 rounded-xl shadow-2xl text-[11px] space-y-1 select-none backdrop-blur-md">
                          <p className="font-semibold text-text-muted">
                            Time: <span className="text-white font-mono">{payload[0].payload.timestamp}</span>
                          </p>
                          <p className="font-semibold text-primary">
                            Retention: <span className="text-white font-mono">{payload[0].value}%</span>
                          </p>
                        </div>
                      );
                    }
